...
FOOD_SAFETY_DATABASE = {
    ...
    "anchois": {"name": "Anchois marinés", "safe_for_pregnancy": "caution", "category": "Poissons", "reason": "Très salé. Consommation occasionnelle."},
    ...
    "coca-cola": {"name": "Coca-Cola", "safe_for_pregnancy": "caution", "category": "Boissons", "reason": "Contient caféine et sucre. Consommation occasionnelle."},
    ...
    "the": {"name": "Thé", "safe_for_pregnancy": "caution", "category": "Boissons", "reason": "Contient caféine et tanins. Consommation occasionnelle."},
    "thon-boite": {"name": "Thon en boîte", "safe_for_pregnancy": "caution", "category": "Poissons", "reason": "Max 150g/semaine (mercure). Consommation occasionnelle."},
    "thon-frais": {"name": "Thon frais", "safe_for_pregnancy": "caution", "category": "Poissons", "reason": "Bien cuire. Consommation occasionnelle (mercure)."},
