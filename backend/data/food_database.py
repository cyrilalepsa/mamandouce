...
FOOD_SAFETY_DATABASE = {
    ...
    "anchois": {"name": "Anchois marinés", "safe_for_pregnancy": "caution", "category": "Poissons", "reason": "À consommer avec modération. Très riche en sel, risque d'hypertension."},
    ...
    "coca-cola": {"name": "Coca-Cola", "safe_for_pregnancy": "caution", "category": "Boissons", "reason": "À consommer avec modération. Caféine + sucre, risque de diabète gestationnel et nervosité."},
    ...
    # ===== I =====
    "infusion": {"name": "Infusion (tisane)", "safe_for_pregnancy": "caution", "category": "Boissons", "reason": "À consommer avec modération. Certaines plantes (sauge, réglisse) peuvent provoquer des contractions."},
    ...
    "pamplemousse": {"name": "Pamplemousse", "safe_for_pregnancy": "caution", "category": "Fruits", "reason": "À consommer avec modération si sous traitement. Peut interagir avec certains médicaments."},
    ...
    "poisson-fume": {"name": "Poisson fumé", "safe_for_pregnancy": "caution", "category": "Poissons", "reason": "À consommer bien cuit uniquement. Fumé à froid : risque de listériose (infection dangereuse)."},
