...
async def send_business_kit_email(admin: User = Depends(get_admin_user)):
    ...
    <body>
        ...
        <ul>
            <li><a href="https://nacre-preview.preview.emergentagent.com/docs/BUSINESS_PLAN_MAMANDOUCE.md">Plan Business (Markdown)</a></li>
            <li><a href="https://nacre-preview.preview.emergentagent.com/docs/CARTE_VISITE_MAMANDOUCE.html">Carte de Visite (HTML)</a></li>
        </ul>
