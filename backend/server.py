...
# ============ BIRTH LIST ENDPOINTS ============

@api_router.get("/birth-list")
...
@api_router.post("/birth-list/items")
...
@api_router.delete("/birth-list/items/{item_id}")
...
@api_router.post("/birth-list/items/{item_id}/toggle")
...
@api_router.get("/birth-list/shared/{share_id}")
async def get_shared_birth_list(share_id: str):
    """Get shared birth list (public)"""
    list_doc = await db.birth_lists.find_one(
        {"share_id": share_id},
        {"_id": 0, "user_id": 0}
    )
...
@api_router.post("/birth-list/shared/{share_id}/items/{item_id}/toggle")
async def toggle_shared_item_reserved(share_id: str, item_id: str):
    """Toggle reserved status from shared link (public)"""
