                        ...
                        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                            ...
                            <div style="padding: 30px 20px;">
                                ...
                                <div style="text-align: center; margin: 30px 0;">
                                    <a href="https://tirelire-staging.preview.emergentagent.com/medical" 
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="center" style="padding: 20px 0;">
                                        <a href="https://tirelire-staging.preview.emergentagent.com/pricing" target="_blank" style="background-color: #8b5cf6; border-radius: 30px; color: #ffffff; display: inline-block; font-size: 16px; font-weight: bold; padding: 16px 40px; text-decoration: none;">Passer à Premium - 27€ pour 9 mois</a>
                                    </td>
                                </tr>
                            </table>
