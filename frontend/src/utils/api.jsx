...
export const api = {
  ...
  get: (url) => axios.get(`${BACKEND_URL}${url}`, getAuthHeaders()),
  post: (url, data) => axios.post(`${BACKEND_URL}${url}`, data, getAuthHeaders()),
  put: (url, data) => axios.put(`${BACKEND_URL}${url}`, data, getAuthHeaders()),
  delete: (url) => axios.delete(`${BACKEND_URL}${url}`, getAuthHeaders()),
