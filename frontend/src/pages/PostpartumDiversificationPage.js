...
import { DiversificationSection } from '../components/postpartum';

export default function PostpartumDiversificationPage() {
  ...
  return (
    <div className="min-h-screen gradient-bg">
      <div className="max-w-2xl mx-auto p-4 sm:p-6">
        <CloudCard color="orange" className="p-4 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-slate-700">Diversification alimentaire</h1>
              <p className="text-sm text-slate-500">Introduction des aliments</p>
            </div>
