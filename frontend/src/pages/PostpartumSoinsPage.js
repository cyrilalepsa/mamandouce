          ...
          {SOINS_ITEMS.map((item) => (
            ...
            >
              ...
              <div className="relative text-center">
                <div className={`w-12 h-12 mx-auto mb-2 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center shadow-lg ${['logo-bubble-yellow','logo-bubble-blue','logo-bubble-red','logo-bubble-green','logo-bubble-violet'][SOINS_ITEMS.indexOf(item) % 5]}`}>
