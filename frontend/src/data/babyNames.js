...
export const babyNamesData = {
  // FRANCE - Base de données enrichie
  FR: {
    girls: {
      A: [
        { name: 'Adèle', meaning: 'Noble, de haute naissance', personality: 'Élégante et raffinée, Adèle possède une grande sensibilité artistique.' },
        { name: 'Alice', meaning: 'De noble lignée', personality: 'Curieuse et imaginative, Alice aime explorer de nouveaux mondes.' },
        { name: 'Amélie', meaning: 'Travailleuse, énergique', personality: 'Douce et attentionnée, Amélie aime aider les autres.' },
        { name: 'Anna', meaning: 'Grâce', personality: 'Simple et authentique, Anna est fiable et loyale.' },
        { name: 'Anaïs', meaning: 'Grâce divine', personality: 'Créative et indépendante, forte personnalité.' },
        { name: 'Agathe', meaning: 'Bonne, vertueuse', personality: 'Sage et réfléchie, personne de confiance.' },
        { name: 'Aurore', meaning: 'Lumière du matin', personality: 'Optimiste et rayonnante, apporte la joie.' },
        { name: 'Apolline', meaning: 'Dédiée à Apollon', personality: 'Brillante et charismatique.' },
        { name: 'Albane', meaning: 'Blanche, pure', personality: 'Pure et sincère, intègre et honnête.' },
        { name: 'Axelle', meaning: 'Père de la paix', personality: 'Dynamique et sportive, battante.' },
        { name: 'Adrienne', meaning: 'De l\'Adriatique', personality: 'Mystérieuse et profonde.' },
        { name: 'Alix', meaning: 'Noble', personality: 'Distinguée et raffinée.' },
        { name: 'Amandine', meaning: 'Digne d\'être aimée', personality: 'Aimante et généreuse.' },
        { name: 'Anaëlle', meaning: 'Grâce de Dieu', personality: 'Spirituelle et douce.' },
        { name: 'Angèle', meaning: 'Messagère', personality: 'Pure et bienveillante.' },
        { name: 'Angélique', meaning: 'Semblable aux anges', personality: 'Céleste et protectrice.' },
        { name: 'Anouchka', meaning: 'Grâce', personality: 'Élégante et charmante.' },
        { name: 'Ariane', meaning: 'Très sainte', personality: 'Guide et éclairante.' },
        { name: 'Armelle', meaning: 'Princesse des ours', personality: 'Forte et protectrice.' },
        { name: 'Astrid', meaning: 'Divine beauté', personality: 'Belle et majestueuse.' },
        { name: 'Athénaïs', meaning: 'Déesse Athéna', personality: 'Sage et guerrière.' },
        { name: 'Aurélie', meaning: 'Dorée', personality: 'Lumineuse et précieuse.' },
        { name: 'Ava', meaning: 'Vie', personality: 'Vivante et énergique.' },
        { name: 'Azélie', meaning: 'Fleur d\'azalée', personality: 'Délicate et colorée.' },
      ],
      B: [
        { name: 'Béatrice', meaning: 'Celle qui rend heureux', personality: 'Joyeuse et bienveillante.' },
        { name: 'Blanche', meaning: 'Pure, blanche', personality: 'Délicate et gracieuse.' },
        { name: 'Brigitte', meaning: 'Force, puissance', personality: 'Forte et déterminée.' },
        { name: 'Bénédicte', meaning: 'Bénie', personality: 'Spirituelle et sage.' },
        { name: 'Barbara', meaning: 'Étrangère', personality: 'Mystérieuse et intrigante.' },
        { name: 'Bertille', meaning: 'Brillante au combat', personality: 'Combative et courageuse.' },
        { name: 'Bianca', meaning: 'Blanche', personality: 'Pure et innocente.' },
        { name: 'Blandine', meaning: 'Caressante', personality: 'Douce et tendre.' },
        { name: 'Brune', meaning: 'Brune', personality: 'Mystérieuse et séduisante.' },
        { name: 'Bérénice', meaning: 'Porteuse de victoire', personality: 'Victorieuse et triomphante.' },
      ],
      C: [
        { name: 'Camille', meaning: 'Assistante de cérémonie', personality: 'Polyvalente et adaptable.' },
        ...
        { name: 'Clara', meaning: 'Claire, brillante', personality: 'Lumineuse et intelligente.' },
        { name: 'Clémence', meaning: 'Douce, clémente', personality: 'Patiente et compréhensive.' },
        { name: 'Céline', meaning: 'Céleste', personality: 'Rêveuse et romantique.' },
        { name: 'Constance', meaning: 'Constante, fidèle', personality: 'Loyale et stable.' },
        { name: 'Capucine', meaning: 'Capuchon de moine', personality: 'Originale et pétillante.' },
        { name: 'Candice', meaning: 'Éclatante de blancheur', personality: 'Pure et rayonnante.' },
        { name: 'Carla', meaning: 'Femme forte', personality: 'Puissante et déterminée.' },
        { name: 'Caroline', meaning: 'Femme libre', personality: 'Indépendante et joyeuse.' },
        { name: 'Cassandra', meaning: 'Qui aide les hommes', personality: 'Protectrice et sage.' },
        { name: 'Catherine', meaning: 'Pure', personality: 'Intègre et honnête.' },
        { name: 'Cécile', meaning: 'Aveugle', personality: 'Intuitive et sensible.' },
        { name: 'Célestine', meaning: 'Céleste', personality: 'Divine et éthérée.' },
        { name: 'Célia', meaning: 'Aveugle', personality: 'Perceptive et sensible.' },
        { name: 'Charline', meaning: 'Femme libre', personality: 'Libre et joyeuse.' },
        { name: 'Christelle', meaning: 'Chrétienne', personality: 'Fidèle et dévouée.' },
        { name: 'Claire', meaning: 'Claire, lumineuse', personality: 'Transparente et honnête.' },
        { name: 'Clarisse', meaning: 'Illustre', personality: 'Célèbre et brillante.' },
        { name: 'Claudia', meaning: 'Boiteuse', personality: 'Persévérante et forte.' },
        { name: 'Cléa', meaning: 'Gloire', personality: 'Glorieuse et fière.' },
        { name: 'Clémentine', meaning: 'Douce', personality: 'Tendre et patiente.' },
        { name: 'Clotilde', meaning: 'Illustre au combat', personality: 'Combative et glorieuse.' },
        { name: 'Colette', meaning: 'Victoire du peuple', personality: 'Populaire et aimée.' },
        { name: 'Coraline', meaning: 'Corail', personality: 'Précieuse et colorée.' },
        { name: 'Corinne', meaning: 'Jeune fille', personality: 'Fraîche et juvénile.' },
        { name: 'Cyrielle', meaning: 'Seigneur', personality: 'Noble et digne.' },
      ],
      D: [
        { name: 'Diane', meaning: 'Divine, lumineuse', personality: 'Majestueuse et indépendante.' },
        { name: 'Delphine', meaning: 'Dauphin', personality: 'Intelligente et intuitive.' },
        { name: 'Domitille', meaning: 'Apprivoisée', personality: 'Douce et paisible.' },
        { name: 'Dorothée', meaning: 'Don de Dieu', personality: 'Généreuse et altruiste.' },
        { name: 'Daphné', meaning: 'Laurier', personality: 'Victorieuse et glorieuse.' },
        { name: 'Déborah', meaning: 'Abeille', personality: 'Travailleuse et organisée.' },
        { name: 'Denise', meaning: 'Consacrée à Dionysos', personality: 'Festive et joyeuse.' },
        { name: 'Désirée', meaning: 'Désirée', personality: 'Aimée et convoitée.' },
        { name: 'Djamila', meaning: 'Belle', personality: 'Belle et gracieuse.' },
        { name: 'Dolorès', meaning: 'Douleurs', personality: 'Empathique et compatissante.' },
        { name: 'Dora', meaning: 'Don', personality: 'Généreuse et donnante.' },
        { name: 'Doriane', meaning: 'Dorée', personality: 'Précieuse et lumineuse.' },
      ],
      E: [
        { name: 'Emma', meaning: 'Toute-puissante', personality: 'Forte et déterminée.' },
        { name: 'Élise', meaning: 'Dieu est mon serment', personality: 'Fidèle et dévouée.' },
        { name: 'Élodie', meaning: 'Richesse étrangère', personality: 'Voyageuse et ouverte.' },
        { name: 'Émilie', meaning: 'Rivale', personality: 'Compétitive et ambitieuse.' },
        { name: 'Eva', meaning: 'Vie', personality: 'Vivante et énergique.' },
        { name: 'Eugénie', meaning: 'Bien née', personality: 'Distinguée et raffinée.' },
        { name: 'Édith', meaning: 'Prospère au combat', personality: 'Victorieuse et prospère.' },
        { name: 'Éléonore', meaning: 'Compassion', personality: 'Empathique et aimante.' },
        { name: 'Éliane', meaning: 'Soleil', personality: 'Radieuse et chaude.' },
        { name: 'Élisa', meaning: 'Dieu est mon serment', personality: 'Fidèle et loyale.' },
        { name: 'Élisabeth', meaning: 'Dieu est serment', personality: 'Noble et royale.' },
        { name: 'Éloïse', meaning: 'Saine', personality: 'En bonne santé et vigoureuse.' },
        { name: 'Elvire', meaning: 'Tout vrai', personality: 'Honnête et sincère.' },
        { name: 'Emmanuelle', meaning: 'Dieu avec nous', personality: 'Protégée et bénie.' },
        { name: 'Ernestine', meaning: 'Sérieuse', personality: 'Appliquée et consciencieuse.' },
        { name: 'Esther', meaning: 'Étoile', personality: 'Brillante et guidante.' },
        { name: 'Eulalie', meaning: 'Bien parler', personality: 'Éloquente et persuasive.' },
        { name: 'Euphrasie', meaning: 'Joie', personality: 'Joyeuse et heureuse.' },
        { name: 'Éva', meaning: 'Vie', personality: 'Pleine de vie.' },
        { name: 'Évangéline', meaning: 'Bonne nouvelle', personality: 'Porteuse de bonnes nouvelles.' },
        { name: 'Ève', meaning: 'Vie', personality: 'Mère de tous, source de vie.' },
        { name: 'Évelyne', meaning: 'Vie', personality: 'Vivante et dynamique.' },
      ],
      F: [
        { name: 'Florence', meaning: 'Florissante', personality: 'Épanouie et radieuse.' },
        { name: 'Fleur', meaning: 'Fleur', personality: 'Délicate et belle.' },
        { name: 'Fanny', meaning: 'Libre', personality: 'Libre et joyeuse.' },
        { name: 'Françoise', meaning: 'Franche', personality: 'Honnête et directe.' },
        { name: 'Fabienne', meaning: 'Fève', personality: 'Simple et naturelle.' },
        { name: 'Faustine', meaning: 'Heureuse', personality: 'Chanceuse et joyeuse.' },
        { name: 'Félicie', meaning: 'Heureuse', personality: 'Joyeuse et satisfaite.' },
        { name: 'Félicité', meaning: 'Bonheur', personality: 'Heureuse et comblée.' },
        { name: 'Fernande', meaning: 'Courageuse', personality: 'Brave et aventurière.' },
        { name: 'Flavie', meaning: 'Blonde', personality: 'Lumineuse et dorée.' },
        { name: 'Flore', meaning: 'Fleur', personality: 'Belle et naturelle.' },
        { name: 'Florentine', meaning: 'Florissante', personality: 'En plein épanouissement.' },
        { name: 'Florine', meaning: 'Fleur', personality: 'Délicate et parfumée.' },
        { name: 'Francine', meaning: 'Franche', personality: 'Sincère et directe.' },
        { name: 'Frédérique', meaning: 'Paix du souverain', personality: 'Paisible et noble.' },
      ],
      G: [
        { name: 'Gabrielle', meaning: 'Force de Dieu', personality: 'Puissante et protectrice.' },
        { name: 'Gaëlle', meaning: 'Généreuse', personality: 'Altruiste et noble de cœur.' },
        { name: 'Gisèle', meaning: 'Noble', personality: 'Gracieuse et élégante.' },
        { name: 'Garance', meaning: 'Plante tinctoriale', personality: 'Colorée et vibrante.' },
        { name: 'Geneviève', meaning: 'Femme de race', personality: 'Noble et distinguée.' },
        { name: 'Georgette', meaning: 'Agricultrice', personality: 'Travailleuse et terre-à-terre.' },
        { name: 'Germaine', meaning: 'Germanique', personality: 'Forte et résistante.' },
        { name: 'Gilberte', meaning: 'Brillante promesse', personality: 'Prometteuse et lumineuse.' },
        { name: 'Gilda', meaning: 'Sacrifice', personality: 'Dévouée et généreuse.' },
        { name: 'Ginette', meaning: 'Bien née', personality: 'Noble et gracieuse.' },
        { name: 'Gladys', meaning: 'Pays', personality: 'Patriote et attachée.' },
        { name: 'Gloria', meaning: 'Gloire', personality: 'Glorieuse et triomphante.' },
        { name: 'Grâce', meaning: 'Grâce divine', personality: 'Bénie et élégante.' },
        { name: 'Guillemette', meaning: 'Volonté de protection', personality: 'Protectrice et déterminée.' },
        { name: 'Gwenaëlle', meaning: 'Blanche et bénie', personality: 'Pure et protégée.' },
        { name: 'Gwendoline', meaning: 'Cercle blanc', personality: 'Mystérieuse et pure.' },
      ],
      H: [
        { name: 'Hélène', meaning: 'Éclat du soleil', personality: 'Lumineuse et chaleureuse.' },
        { name: 'Héloïse', meaning: 'Saine', personality: 'Forte et en bonne santé.' },
        { name: 'Honorine', meaning: 'Honorée', personality: 'Digne et respectable.' },
        { name: 'Harmonie', meaning: 'Harmonie', personality: 'Équilibrée et paisible.' },
        { name: 'Harriet', meaning: 'Chef de maison', personality: 'Responsable et organisée.' },
        { name: 'Hélèna', meaning: 'Éclat', personality: 'Brillante et rayonnante.' },
        { name: 'Henriette', meaning: 'Maître de maison', personality: 'Responsable et fiable.' },
        { name: 'Hermine', meaning: 'Soldatesque', personality: 'Forte et combative.' },
        { name: 'Hortense', meaning: 'Jardin', personality: 'Naturelle et épanouie.' },
        { name: 'Huguette', meaning: 'Intelligence', personality: 'Brillante et sage.' },
        { name: 'Hyacinthe', meaning: 'Jacinthe', personality: 'Parfumée et délicate.' },
      ],
      I: [
        { name: 'Inès', meaning: 'Pure', personality: 'Pure et innocente.' },
        { name: 'Iris', meaning: 'Arc-en-ciel', personality: 'Colorée et joyeuse.' },
        { name: 'Isabelle', meaning: 'Dieu est mon serment', personality: 'Fidèle et dévouée.' },
        { name: 'Irène', meaning: 'Paix', personality: 'Paisible et sereine.' },
        { name: 'Irma', meaning: 'Universelle', personality: 'Ouverte et accueillante.' },
        { name: 'Isadora', meaning: 'Don d\'Isis', personality: 'Mystique et bénie.' },
        { name: 'Isaline', meaning: 'Consacrée à Dieu', personality: 'Spirituelle et dévouée.' },
        { name: 'Iseult', meaning: 'Belle', personality: 'Belle et tragique.' },
        { name: 'Ivana', meaning: 'Dieu est gracieux', personality: 'Gracieuse et élégante.' },
      ...
      J: [
        ...
        { name: 'Julie', meaning: 'De la famille de Jules', personality: 'Douce et aimante.' },
        ...
        { name: 'Jacqueline', meaning: 'Supplanteur', personality: 'Stratège et intelligente.' },
        { name: 'Janine', meaning: 'Dieu fait grâce', personality: 'Bénie et reconnaissante.' },
        { name: 'Jeanine', meaning: 'Dieu est gracieux', personality: 'Gracieuse et aimable.' },
        { name: 'Jeannette', meaning: 'Petite Jeanne', personality: 'Courageuse comme Jeanne.' },
        { name: 'Jennifer', meaning: 'Blanche fée', personality: 'Magique et enchanteresse.' },
        { name: 'Jessica', meaning: 'Dieu regarde', personality: 'Observée et protégée.' },
        { name: 'Joanna', meaning: 'Dieu fait grâce', personality: 'Gracieuse et bénie.' },
        { name: 'Jocelyne', meaning: 'Joyeuse', personality: 'Gaie et enthousiaste.' },
        { name: 'Joëlle', meaning: 'Dieu est Dieu', personality: 'Fidèle et croyante.' },
        { name: 'Joséphine', meaning: 'Dieu ajoutera', personality: 'Bénie et prospère.' },
        { name: 'Joy', meaning: 'Joie', personality: 'Joyeuse et rayonnante.' },
        { name: 'Joyce', meaning: 'Joyeuse', personality: 'Heureuse et positive.' },
        { name: 'Judith', meaning: 'Juive', personality: 'Courageuse et déterminée.' },
        { name: 'Julia', meaning: 'De Jules', personality: 'Noble et raffinée.' },
        { name: 'Juliane', meaning: 'De Jules', personality: 'Élégante et gracieuse.' },
      ],
      K: [
        { name: 'Karen', meaning: 'Pure', personality: 'Simple et authentique.' },
        { name: 'Karine', meaning: 'Pure', personality: 'Claire et transparente.' },
        { name: 'Kate', meaning: 'Pure', personality: 'Élégante et raffinée.' },
        { name: 'Katherine', meaning: 'Pure', personality: 'Noble et distinguée.' },
        { name: 'Kelly', meaning: 'Guerrière', personality: 'Combative et forte.' },
        { name: 'Kenza', meaning: 'Trésor', personality: 'Précieuse et rare.' },
        { name: 'Kéra', meaning: 'Rayon de lumière', personality: 'Lumineuse et brillante.' },
        { name: 'Kim', meaning: 'Noble', personality: 'Distinguée et fière.' },
        { name: 'Kira', meaning: 'Lumière', personality: 'Brillante et éclairante.' },
        { name: 'Klara', meaning: 'Claire', personality: 'Transparente et honnête.' },
      ],
      L: [
        ...
        { name: 'Lilou', meaning: 'Lys', personality: 'Pure et délicate.' },
        { name: 'Laetitia', meaning: 'Joie', personality: 'Joyeuse et heureuse.' },
        { name: 'Lana', meaning: 'Lumière', personality: 'Brillante et douce.' },
        { name: 'Laure', meaning: 'Laurier', personality: 'Victorieuse et glorieuse.' },
        { name: 'Laurence', meaning: 'Laurier', personality: 'Triomphante et noble.' },
        { name: 'Lauriane', meaning: 'Laurier', personality: 'Glorieuse et belle.' },
        { name: 'Laurine', meaning: 'Laurier', personality: 'Victorieuse et radieuse.' },
        { name: 'Léana', meaning: 'Lumière du soleil', personality: 'Radieuse et chaude.' },
        { name: 'Léane', meaning: 'Généreuse', personality: 'Altruiste et donnante.' },
        { name: 'Léna', meaning: 'Éclat', personality: 'Brillante et vive.' },
        { name: 'Léonore', meaning: 'Compassion', personality: 'Empathique et aimante.' },
        { name: 'Lila', meaning: 'Lilas', personality: 'Parfumée et délicate.' },
        { name: 'Lilian', meaning: 'Lys', personality: 'Pure et élégante.' },
        { name: 'Liliane', meaning: 'Lys', personality: 'Gracieuse et raffinée.' },
        { name: 'Lily', meaning: 'Lys', personality: 'Innocente et pure.' },
        { name: 'Lina', meaning: 'Tendre', personality: 'Douce et affectueuse.' },
        { name: 'Lisa', meaning: 'Dieu est serment', personality: 'Fidèle et loyale.' },
        { name: 'Lisette', meaning: 'Petite Lisa', personality: 'Mignonne et adorable.' },
        { name: 'Livia', meaning: 'Vie', personality: 'Pleine de vie.' },
        { name: 'Loane', meaning: 'Lumière', personality: 'Brillante et éclairante.' },
        { name: 'Lorène', meaning: 'Laurier', personality: 'Victorieuse et fière.' },
        { name: 'Lorraine', meaning: 'De Lorraine', personality: 'Patriote et fière.' },
        { name: 'Lou', meaning: 'Glorieuse combattante', personality: 'Forte et déterminée.' },
        ...
        { name: 'Lucette', meaning: 'Petite lumière', personality: 'Scintillante et joyeuse.' },
        { name: 'Lucienne', meaning: 'Lumière', personality: 'Éclairante et sage.' },
        { name: 'Lucile', meaning: 'Lumière', personality: 'Brillante et vive.' },
        { name: 'Lucinde', meaning: 'Lumière', personality: 'Éclairante et douce.' },
        { name: 'Luna', meaning: 'Lune', personality: 'Mystérieuse et douce.' },
        { name: 'Lydie', meaning: 'De Lydie', personality: 'Exotique et raffinée.' },
        { name: 'Lyse', meaning: 'Lys', personality: 'Pure et élégante.' },
      ],
      M: [
        { name: 'Manon', meaning: 'Celle qui élève', personality: 'Maternelle et protectrice.' },
        { name: 'Marie', meaning: 'Goutte de mer', personality: 'Douce et aimante.' },
        { name: 'Margaux', meaning: 'Perle', personality: 'Précieuse et raffinée.' },
        { name: 'Mathilde', meaning: 'Puissante au combat', personality: 'Forte et déterminée.' },
        ...
        { name: 'Madeleine', meaning: 'De Magdala', personality: 'Fidèle et dévouée.' },
        { name: 'Maëlle', meaning: 'Princesse', personality: 'Noble et gracieuse.' },
        ...
        { name: 'Magali', meaning: 'Perle', personality: 'Précieuse et unique.' },
        { name: 'Mahaut', meaning: 'Puissante au combat', personality: 'Forte et combative.' },
        { name: 'Mailys', meaning: 'Chef', personality: 'Dirigeante et sage.' },
        { name: 'Malika', meaning: 'Reine', personality: 'Royale et majestueuse.' },
        { name: 'Marcelline', meaning: 'Petite guerrière', personality: 'Combative et déterminée.' },
        { name: 'Margot', meaning: 'Perle', personality: 'Précieuse et brillante.' },
        { name: 'Marguerite', meaning: 'Perle', personality: 'Pure et précieuse.' },
        { name: 'Marianne', meaning: 'Grâce de Marie', personality: 'Gracieuse et patriote.' },
        ...
        { name: 'Marjorie', meaning: 'Perle', personality: 'Précieuse et rare.' },
        { name: 'Marlène', meaning: 'De Magdala', personality: 'Glamour et séduisante.' },
        { name: 'Marthe', meaning: 'Dame', personality: 'Noble et serviable.' },
        { name: 'Martine', meaning: 'De Mars', personality: 'Combative et forte.' },
        { name: 'Marylène', meaning: 'Marie et Hélène', personality: 'Douce et lumineuse.' },
        { name: 'Maryse', meaning: 'Aimée de Dieu', personality: 'Bénie et chérie.' },
        { name: 'Maureen', meaning: 'Amère', personality: 'Sensible et profonde.' },
        { name: 'Maxine', meaning: 'La plus grande', personality: 'Ambitieuse et déterminée.' },
        { name: 'Maya', meaning: 'Illusion', personality: 'Mystique et enchanteresse.' },
        { name: 'Mégane', meaning: 'Perle', personality: 'Précieuse et brillante.' },
        { name: 'Mélina', meaning: 'Miel', personality: 'Douce et sucrée.' },
        { name: 'Mélinda', meaning: 'Miel doux', personality: 'Tendre et aimante.' },
        { name: 'Mélissa', meaning: 'Abeille', personality: 'Travailleuse et organisée.' },
        { name: 'Mélodie', meaning: 'Chant', personality: 'Musicale et harmonieuse.' },
        { name: 'Michèle', meaning: 'Qui est comme Dieu', personality: 'Humble et spirituelle.' },
        { name: 'Mireille', meaning: 'Admirable', personality: 'Admirable et respectée.' },
        { name: 'Monique', meaning: 'Conseillère', personality: 'Sage et avisée.' },
        { name: 'Muriel', meaning: 'Mer brillante', personality: 'Lumineuse et profonde.' },
        { name: 'Mylène', meaning: 'Qui vient de Milet', personality: 'Exotique et charmante.' },
        { name: 'Myriam', meaning: 'Aimée', personality: 'Chérie et adorée.' },
      ],
      N: [
        { name: 'Nina', meaning: 'Grâce', personality: 'Gracieuse et élégante.' },
        { name: 'Noémie', meaning: 'Agréable', personality: 'Agréable et douce.' },
        { name: 'Nathalie', meaning: 'Jour de naissance', personality: 'Festive et joyeuse.' },
        { name: 'Nadège', meaning: 'Espoir', personality: 'Optimiste et positive.' },
        { name: 'Nadine', meaning: 'Espoir', personality: 'Pleine d\'espoir.' },
        { name: 'Nancy', meaning: 'Grâce', personality: 'Gracieuse et élégante.' },
        { name: 'Naomi', meaning: 'Agréable', personality: 'Belle et douce.' },
        { name: 'Natacha', meaning: 'Jour de naissance', personality: 'Joyeuse et festive.' },
        { name: 'Nella', meaning: 'Lumière', personality: 'Brillante et éclairante.' },
        { name: 'Nelly', meaning: 'Éclat du soleil', personality: 'Radieuse et chaude.' },
        { name: 'Nicole', meaning: 'Victoire du peuple', personality: 'Populaire et victorieuse.' },
        { name: 'Nicolette', meaning: 'Petite victoire', personality: 'Gagnante et déterminée.' },
        { name: 'Nine', meaning: 'Grâce', personality: 'Gracieuse et simple.' },
        { name: 'Noëlle', meaning: 'Noël', personality: 'Festive et généreuse.' },
        { name: 'Nolwenn', meaning: 'Blanche', personality: 'Pure et sainte.' },
      ...
      O: [
        ...
        { name: 'Odette', meaning: 'Richesse', personality: 'Prospère et généreuse.' },
        { name: 'Odile', meaning: 'Richesse', personality: 'Fortunée et sage.' },
        { name: 'Olympe', meaning: 'De l\'Olympe', personality: 'Divine et majestueuse.' },
        { name: 'Ondine', meaning: 'Petite vague', personality: 'Fluide et gracieuse.' },
        { name: 'Oriane', meaning: 'Dorée', personality: 'Lumineuse et précieuse.' },
        { name: 'Orlane', meaning: 'Dorée', personality: 'Brillante et radieuse.' },
        { name: 'Ornella', meaning: 'Frêne fleuri', personality: 'Belle et naturelle.' },
      ],
      P: [
        ...
        { name: 'Priscille', meaning: 'Ancienne', personality: 'Sage et expérimentée.' },
        { name: 'Pascale', meaning: 'De Pâques', personality: 'Renouvelée et joyeuse.' },
        { name: 'Patricia', meaning: 'Noble', personality: 'Distinguée et raffinée.' },
        { name: 'Paula', meaning: 'Petite', personality: 'Modeste et humble.' },
        { name: 'Paule', meaning: 'Petite', personality: 'Simple et authentique.' },
        { name: 'Paulette', meaning: 'Petite', personality: 'Mignonne et discrète.' },
        { name: 'Perle', meaning: 'Perle', personality: 'Précieuse et rare.' },
        { name: 'Pernelle', meaning: 'Pierre', personality: 'Solide et fiable.' },
        { name: 'Perrine', meaning: 'Pierre', personality: 'Forte et stable.' },
        { name: 'Pétronille', meaning: 'Pierre', personality: 'Solide et déterminée.' },
        { name: 'Philomène', meaning: 'Aimée', personality: 'Chérie et adorée.' },
        { name: 'Pierrette', meaning: 'Petite pierre', personality: 'Solide et fidèle.' },
        { name: 'Prune', meaning: 'Prune', personality: 'Douce et savoureuse.' },
      ],
      Q: [
        { name: 'Quitterie', meaning: 'Tranquille', personality: 'Calme et sereine.' },
        { name: 'Quentine', meaning: 'Cinquième', personality: 'Équilibrée et harmonieuse.' },
      ],
      R: [
        { name: 'Rose', meaning: 'Rose', personality: 'Belle et parfumée.' },
        { name: 'Romane', meaning: 'Romaine', personality: 'Forte et endurante.' },
        { name: 'Rachel', meaning: 'Brebis', personality: 'Douce et docile.' },
        { name: 'Raphaëlle', meaning: 'Dieu guérit', personality: 'Guérisseuse et bienveillante.' },
        { name: 'Rebecca', meaning: 'Attacher', personality: 'Fidèle et attachée.' },
        { name: 'Régine', meaning: 'Reine', personality: 'Royale et majestueuse.' },
        { name: 'Reine', meaning: 'Reine', personality: 'Noble et souveraine.' },
        { name: 'Renée', meaning: 'Renaître', personality: 'Renouvelée et transformée.' },
        { name: 'Rita', meaning: 'Perle', personality: 'Précieuse et rare.' },
        { name: 'Roberte', meaning: 'Gloire brillante', personality: 'Glorieuse et brillante.' },
        { name: 'Rolande', meaning: 'Gloire du pays', personality: 'Patriote et fière.' },
        { name: 'Rosalie', meaning: 'Rose', personality: 'Belle et délicate.' },
        { name: 'Rosaline', meaning: 'Jolie rose', personality: 'Magnifique et gracieuse.' },
        { name: 'Roseline', meaning: 'Rose douce', personality: 'Tendre et parfumée.' },
        { name: 'Rosemonde', meaning: 'Protectrice des chevaux', personality: 'Protectrice et noble.' },
        { name: 'Rosette', meaning: 'Petite rose', personality: 'Mignonne et délicate.' },
        { name: 'Rosine', meaning: 'Rose', personality: 'Fraîche et belle.' },
        { name: 'Roxane', meaning: 'Aurore', personality: 'Lumineuse et nouvelle.' },
        { name: 'Ruth', meaning: 'Amie', personality: 'Fidèle et loyale.' },
      ],
      S: [
        { name: 'Sarah', meaning: 'Princesse', personality: 'Royale et majestueuse.' },
        { name: 'Sophie', meaning: 'Sagesse', personality: 'Sage et intelligente.' },
        { name: 'Solène', meaning: 'Solennelle', personality: 'Sérieuse et digne.' },
        { name: 'Stéphanie', meaning: 'Couronnée', personality: 'Victorieuse et accomplie.' },
        { name: 'Sabine', meaning: 'Sabine', personality: 'Forte et résistante.' },
        { name: 'Sabrina', meaning: 'Princesse', personality: 'Royale et enchanteresse.' },
        { name: 'Salomé', meaning: 'Paix', personality: 'Paisible et gracieuse.' },
        { name: 'Sandra', meaning: 'Protectrice', personality: 'Protectrice et forte.' },
        { name: 'Sandrine', meaning: 'Protectrice', personality: 'Défenseur et loyale.' },
        { name: 'Séraphine', meaning: 'Brûlante', personality: 'Passionnée et ardente.' },
        { name: 'Séverine', meaning: 'Sévère', personality: 'Stricte mais juste.' },
        { name: 'Sidonie', meaning: 'De Sidon', personality: 'Exotique et mystérieuse.' },
        { name: 'Simone', meaning: 'Qui écoute', personality: 'Attentive et sage.' },
        { name: 'Sixtine', meaning: 'Sixième', personality: 'Unique et spéciale.' },
        { name: 'Sonia', meaning: 'Sagesse', personality: 'Sage et réfléchie.' },
        { name: 'Soraya', meaning: 'Princesse', personality: 'Noble et gracieuse.' },
        { name: 'Suzanne', meaning: 'Lys', personality: 'Pure et élégante.' },
        { name: 'Suzette', meaning: 'Petit lys', personality: 'Délicate et charmante.' },
        { name: 'Sylvaine', meaning: 'De la forêt', personality: 'Naturelle et sauvage.' },
        { name: 'Sylvie', meaning: 'De la forêt', personality: 'Proche de la nature.' },
      ],
      T: [
        { name: 'Théa', meaning: 'Déesse', personality: 'Divine et inspirante.' },
        { name: 'Tiphaine', meaning: 'Apparition de Dieu', personality: 'Spirituelle et lumineuse.' },
        { name: 'Tatiana', meaning: 'Roi', personality: 'Royale et majestueuse.' },
        { name: 'Thaïs', meaning: 'Bandeau', personality: 'Élégante et raffinée.' },
        { name: 'Thérèse', meaning: 'Chasseresse', personality: 'Déterminée et persévérante.' },
        { name: 'Tina', meaning: 'Chrétienne', personality: 'Fidèle et dévouée.' },
      ],
      U: [
        { name: 'Ursule', meaning: 'Petite ourse', personality: 'Protectrice et maternelle.' },
        { name: 'Uranie', meaning: 'Céleste', personality: 'Divine et éthérée.' },
      ],
      V: [
        ...
        { name: 'Violette', meaning: 'Violet', personality: 'Discrète et modeste.' },
        { name: 'Valérie', meaning: 'Vaillante', personality: 'Courageuse et forte.' },
        { name: 'Vanessa', meaning: 'Papillon', personality: 'Légère et gracieuse.' },
        { name: 'Véronique', meaning: 'Porteuse de victoire', personality: 'Victorieuse et triomphante.' },
        { name: 'Virginie', meaning: 'Vierge', personality: 'Pure et innocente.' },
        { name: 'Viviane', meaning: 'Vivante', personality: 'Pleine de vie.' },
        { name: 'Vivienne', meaning: 'Vivante', personality: 'Dynamique et énergique.' },
      ],
      W: [
        { name: 'Wendy', meaning: 'Amie', personality: 'Amicale et loyale.' },
        { name: 'Wanda', meaning: 'Vagabonde', personality: 'Libre et aventurière.' },
        { name: 'Wilhelmine', meaning: 'Protectrice', personality: 'Protectrice et forte.' },
      ],
      X: [
        { name: 'Xénia', meaning: 'Hospitalière', personality: 'Accueillante et généreuse.' },
        { name: 'Ximena', meaning: 'Qui écoute', personality: 'Attentive et sage.' },
      ],
      Y: [
        { name: 'Yasmine', meaning: 'Jasmin', personality: 'Parfumée et délicate.' },
        { name: 'Yvonne', meaning: 'If', personality: 'Solide et durable.' },
        { name: 'Yolande', meaning: 'Violette', personality: 'Discrète et belle.' },
        { name: 'Ysaline', meaning: 'Consacrée à Dieu', personality: 'Spirituelle et dévouée.' },
        { name: 'Yvette', meaning: 'If', personality: 'Résistante et forte.' },
      ],
      Z: [
        { name: 'Zoé', meaning: 'Vie', personality: 'Vivante et dynamique.' },
        { name: 'Zélie', meaning: 'Zèle', personality: 'Enthousiaste et passionnée.' },
        { name: 'Zéphyrine', meaning: 'Vent d\'ouest', personality: 'Libre et légère.' },
        { name: 'Zineb', meaning: 'Belle plante', personality: 'Naturelle et belle.' },
        { name: 'Zohra', meaning: 'Fleur', personality: 'Épanouie et radieuse.' },
      ],
    },
    boys: {
      A: [
        { name: 'Adam', meaning: 'Fait de terre rouge', personality: 'Pionnier qui ouvre la voie.' },
        { name: 'Alexandre', meaning: 'Défenseur de l\'humanité', personality: 'Protecteur et courageux.' },
        ...
        { name: 'Axel', meaning: 'Père de la paix', personality: 'Pacifique et diplomate.' },
        { name: 'Adrien', meaning: 'De l\'Adriatique', personality: 'Aventurier et curieux.' },
        { name: 'Arnaud', meaning: 'Aigle puissant', personality: 'Majestueux et visionnaire.' },
        { name: 'Abel', meaning: 'Souffle', personality: 'Léger et spirituel.' },
        { name: 'Achille', meaning: 'Douleur', personality: 'Fort et invincible.' },
        { name: 'Adolphe', meaning: 'Loup noble', personality: 'Noble et courageux.' },
        { name: 'Alain', meaning: 'Beau', personality: 'Élégant et charmant.' },
        { name: 'Alban', meaning: 'Blanc', personality: 'Pur et lumineux.' },
        { name: 'Albert', meaning: 'Noble et brillant', personality: 'Distingué et intelligent.' },
        { name: 'Alexis', meaning: 'Défenseur', personality: 'Protecteur et loyal.' },
        { name: 'Alfred', meaning: 'Conseiller elfique', personality: 'Sage et mystérieux.' },
        { name: 'Alphonse', meaning: 'Noble et prêt', personality: 'Noble et préparé.' },
        { name: 'Amaury', meaning: 'Chef puissant', personality: 'Leader et fort.' },
        { name: 'Ambroise', meaning: 'Immortel', personality: 'Éternel et sage.' },
        { name: 'Anatole', meaning: 'Lever du soleil', personality: 'Nouveau et prometteur.' },
        { name: 'André', meaning: 'Courageux', personality: 'Brave et viril.' },
        { name: 'Ange', meaning: 'Messager', personality: 'Pur et bienveillant.' },
        { name: 'Anselme', meaning: 'Protection divine', personality: 'Protégé et sage.' },
        { name: 'Antonin', meaning: 'Inestimable', personality: 'Précieux et rare.' },
        { name: 'Aristide', meaning: 'Le meilleur', personality: 'Excellent et vertueux.' },
        { name: 'Armand', meaning: 'Homme d\'armée', personality: 'Fort et discipliné.' },
      ],
      B: [
        { name: 'Baptiste', meaning: 'Celui qui baptise', personality: 'Spirituel et bienveillant.' },
        { name: 'Benjamin', meaning: 'Fils de la main droite', personality: 'Chanceux et talentueux.' },
        { name: 'Benoît', meaning: 'Béni', personality: 'Béni et heureux.' },
        { name: 'Bruno', meaning: 'Brun', personality: 'Protecteur et solide.' },
        { name: 'Barnabé', meaning: 'Fils de consolation', personality: 'Réconfortant et sage.' },
        { name: 'Barthélémy', meaning: 'Fils de Talmay', personality: 'Travailleur et honnête.' },
        { name: 'Basile', meaning: 'Royal', personality: 'Noble et digne.' },
        { name: 'Bastien', meaning: 'Vénérable', personality: 'Respecté et admiré.' },
        { name: 'Bernard', meaning: 'Fort comme un ours', personality: 'Puissant et courageux.' },
        { name: 'Bertrand', meaning: 'Corbeau brillant', personality: 'Intelligent et mystérieux.' },
        { name: 'Blaise', meaning: 'Bègue', personality: 'Réfléchi et sage.' },
        { name: 'Brice', meaning: 'Tacheté', personality: 'Unique et original.' },
      ],
      C: [
        ...
        { name: 'Christophe', meaning: 'Porteur du Christ', personality: 'Dévoué et fidèle.' },
        { name: 'Cyril', meaning: 'Seigneur', personality: 'Noble et digne.' },
        { name: 'Colin', meaning: 'Jeune chiot', personality: 'Joueur et énergique.' },
        { name: 'Camille', meaning: 'Assistant de cérémonie', personality: 'Polyvalent et adaptable.' },
        { name: 'Cédric', meaning: 'Chef de guerre', personality: 'Leader et stratège.' },
        { name: 'César', meaning: 'Chevelu', personality: 'Impérial et puissant.' },
        { name: 'Christian', meaning: 'Chrétien', personality: 'Fidèle et dévoué.' },
        { name: 'Claude', meaning: 'Boiteux', personality: 'Persévérant et fort.' },
        { name: 'Corentin', meaning: 'Ami', personality: 'Amical et loyal.' },
        { name: 'Côme', meaning: 'Ordre', personality: 'Ordonné et méthodique.' },
        { name: 'Constant', meaning: 'Constant', personality: 'Stable et fiable.' },
        { name: 'Cyprien', meaning: 'De Chypre', personality: 'Exotique et charmant.' },
      ],
      D: [
        { name: 'Damien', meaning: 'Dompter', personality: 'Maître de lui-même.' },
        { name: 'David', meaning: 'Bien-aimé', personality: 'Aimé de tous.' },
        { name: 'Denis', meaning: 'Consacré à Dionysos', personality: 'Festif et joyeux.' },
        { name: 'Dylan', meaning: 'Fils de la mer', personality: 'Libre comme la mer.' },
        { name: 'Daniel', meaning: 'Dieu est juge', personality: 'Juste et équitable.' },
        { name: 'Didier', meaning: 'Désiré', personality: 'Aimé et voulu.' },
        { name: 'Dimitri', meaning: 'Consacré à Déméter', personality: 'Nourricier et généreux.' },
        { name: 'Dominique', meaning: 'Du Seigneur', personality: 'Spirituel et dévoué.' },
        { name: 'Dorian', meaning: 'Don de Dieu', personality: 'Béni et talentueux.' },
      ],
      E: [
        { name: 'Émile', meaning: 'Rival', personality: 'Compétitif et ambitieux.' },
        { name: 'Étienne', meaning: 'Couronné', personality: 'Victorieux et accompli.' },
        { name: 'Emmanuel', meaning: 'Dieu est avec nous', personality: 'Protégé et guidé.' },
        { name: 'Éric', meaning: 'Roi pour toujours', personality: 'Royal et éternel.' },
        { name: 'Édouard', meaning: 'Gardien des richesses', personality: 'Prudent et responsable.' },
        { name: 'Edgar', meaning: 'Gardien de la prospérité', personality: 'Protecteur et sage.' },
        { name: 'Edmond', meaning: 'Protecteur prospère', personality: 'Fortuné et protecteur.' },
        { name: 'Elias', meaning: 'Dieu est mon Dieu', personality: 'Fidèle et spirituel.' },
        { name: 'Elie', meaning: 'Mon Dieu est Yahvé', personality: 'Prophétique et sage.' },
        { name: 'Eloi', meaning: 'Élu', personality: 'Choisi et spécial.' },
        { name: 'Emilien', meaning: 'Rival', personality: 'Compétiteur et fort.' },
        { name: 'Enzo', meaning: 'Maître de maison', personality: 'Responsable et chef.' },
        { name: 'Erwan', meaning: 'If', personality: 'Résistant et durable.' },
        { name: 'Eugène', meaning: 'Bien né', personality: 'Noble et distingué.' },
        { name: 'Eustache', meaning: 'Fécond', personality: 'Fertile et créatif.' },
        { name: 'Evan', meaning: 'Jeune guerrier', personality: 'Combatif et courageux.' },
        { name: 'Evrard', meaning: 'Fort comme un sanglier', personality: 'Puissant et déterminé.' },
      ],
      F: [
        { name: 'Fabien', meaning: 'Fève', personality: 'Simple et terre-à-terre.' },
        { name: 'Florian', meaning: 'Fleuri', personality: 'Épanoui et radieux.' },
        { name: 'François', meaning: 'Franc', personality: 'Honnête et direct.' },
        { name: 'Frédéric', meaning: 'Paix du souverain', personality: 'Paisible et noble.' },
        { name: 'Fabrice', meaning: 'Artisan', personality: 'Créatif et habile.' },
        { name: 'Félix', meaning: 'Heureux', personality: 'Joyeux et chanceux.' },
        { name: 'Ferdinand', meaning: 'Voyageur courageux', personality: 'Aventurier et brave.' },
        { name: 'Fernand', meaning: 'Courageux', personality: 'Brave et déterminé.' },
        { name: 'Firmin', meaning: 'Ferme', personality: 'Stable et résolu.' },
        { name: 'Foucault', meaning: 'Peuple puissant', personality: 'Fort et populaire.' },
        { name: 'Francis', meaning: 'Français', personality: 'Patriote et fier.' },
        { name: 'Franck', meaning: 'Homme libre', personality: 'Libre et indépendant.' },
      ],
      G: [
        { name: 'Gabriel', meaning: 'Force de Dieu', personality: 'Puissant et protecteur.' },
        { name: 'Gauthier', meaning: 'Chef d\'armée', personality: 'Leader et stratège.' },
        { name: 'Guillaume', meaning: 'Volonté et protection', personality: 'Déterminé et protecteur.' },
        { name: 'Grégoire', meaning: 'Vigilant', personality: 'Attentif et prudent.' },
        { name: 'Gaël', meaning: 'Généreux', personality: 'Altruiste et noble.' },
        { name: 'Gaspard', meaning: 'Gardien du trésor', personality: 'Protecteur et sage.' },
        { name: 'Gaston', meaning: 'Hôte', personality: 'Accueillant et chaleureux.' },
        { name: 'Gérald', meaning: 'Lance qui gouverne', personality: 'Leader et puissant.' },
        { name: 'Gérard', meaning: 'Lance brave', personality: 'Courageux et fort.' },
        { name: 'Germain', meaning: 'Frère', personality: 'Fraternel et loyal.' },
        { name: 'Gervais', meaning: 'Lance', personality: 'Guerrier et noble.' },
        { name: 'Gilbert', meaning: 'Brillante promesse', personality: 'Prometteur et lumineux.' },
        { name: 'Gilles', meaning: 'Jeune chèvre', personality: 'Agile et vif.' },
        { name: 'Gonzague', meaning: 'Combat', personality: 'Combatif et brave.' },
        { name: 'Gratien', meaning: 'Grâce', personality: 'Gracieux et élégant.' },
        { name: 'Guy', meaning: 'Guide', personality: 'Guide et leader.' },
      ],
      H: [
        { name: 'Henri', meaning: 'Maître de maison', personality: 'Responsable et fiable.' },
        { name: 'Hugo', meaning: 'Esprit', personality: 'Brillant et créatif.' },
        { name: 'Hervé', meaning: 'Combat digne', personality: 'Honorable et courageux.' },
        { name: 'Hadrien', meaning: 'De l\'Adriatique', personality: 'Aventurier et curieux.' },
        { name: 'Hector', meaning: 'Qui tient bon', personality: 'Résistant et fort.' },
        { name: 'Hilaire', meaning: 'Joyeux', personality: 'Gai et optimiste.' },
        { name: 'Hippolyte', meaning: 'Qui dételle les chevaux', personality: 'Libre et sauvage.' },
        { name: 'Honoré', meaning: 'Honoré', personality: 'Respectable et digne.' },
        { name: 'Hubert', meaning: 'Esprit brillant', personality: 'Intelligent et vif.' },
        { name: 'Hugues', meaning: 'Esprit', personality: 'Penseur et philosophe.' },
      ],
      I: [
        { name: 'Isaac', meaning: 'Il rira', personality: 'Joyeux et optimiste.' },
        { name: 'Ivan', meaning: 'Dieu fait grâce', personality: 'Béni et reconnaissant.' },
        { name: 'Igor', meaning: 'Guerrier', personality: 'Combattant et fort.' },
        { name: 'Ignace', meaning: 'Feu', personality: 'Passionné et ardent.' },
        { name: 'Irénée', meaning: 'Paix', personality: 'Paisible et serein.' },
        { name: 'Isidore', meaning: 'Don d\'Isis', personality: 'Béni et mystique.' },
      ],
      J: [
        ...
        { name: 'Jacques', meaning: 'Supplanteur', personality: 'Stratège et intelligent.' },
        { name: 'Jérôme', meaning: 'Nom sacré', personality: 'Spirituel et sage.' },
        { name: 'Jérémy', meaning: 'Dieu élèvera', personality: 'Élevé et béni.' },
        { name: 'Joachim', meaning: 'Dieu établira', personality: 'Stable et fondé.' },
        ...
        { name: 'Jordan', meaning: 'Descendant', personality: 'Héritier et noble.' },
        { name: 'Joseph', meaning: 'Dieu ajoutera', personality: 'Béni et prospère.' },
        { name: 'Josse', meaning: 'Seigneur', personality: 'Noble et digne.' },
        { name: 'Justin', meaning: 'Juste', personality: 'Équitable et honnête.' },
      ],
      K: [
        { name: 'Kevin', meaning: 'Beau de naissance', personality: 'Charmant et séduisant.' },
        { name: 'Killian', meaning: 'Église', personality: 'Combatif et fidèle.' },
        { name: 'Karl', meaning: 'Homme libre', personality: 'Libre et indépendant.' },
        { name: 'Kévin', meaning: 'Gentil', personality: 'Aimable et doux.' },
      ],
      L: [
        ...
        { name: 'Laurent', meaning: 'Laurier', personality: 'Victorieux et couronné.' },
        { name: 'Luc', meaning: 'Lumière', personality: 'Clair et transparent.' },
        { name: 'Léon', meaning: 'Lion', personality: 'Puissant et majestueux.' },
        { name: 'Léonard', meaning: 'Fort comme un lion', personality: 'Puissant et créatif.' },
        { name: 'Lionel', meaning: 'Petit lion', personality: 'Courageux et vif.' },
        { name: 'Logan', meaning: 'Petite vallée', personality: 'Paisible et naturel.' },
        { name: 'Loïc', meaning: 'Lumière', personality: 'Brillant et guidant.' },
        { name: 'Lorenzo', meaning: 'Laurier', personality: 'Victorieux et passionné.' },
        { name: 'Lucien', meaning: 'Lumière', personality: 'Éclairant et sage.' },
        { name: 'Ludovic', meaning: 'Célèbre combattant', personality: 'Glorieux et fort.' },
      ],
      M: [
        { name: 'Mathieu', meaning: 'Don de Dieu', personality: 'Béni et généreux.' },
        { name: 'Maxime', meaning: 'Le plus grand', personality: 'Ambitieux et déterminé.' },
        { name: 'Martin', meaning: 'Guerrier de Mars', personality: 'Combatif et courageux.' },
        { name: 'Marc', meaning: 'Consacré à Mars', personality: 'Fort et martial.' },
        { name: 'Michel', meaning: 'Qui est comme Dieu', personality: 'Humble et spirituel.' },
        { name: 'Maël', meaning: 'Prince', personality: 'Noble et chef.' },
        { name: 'Malo', meaning: 'Gage', personality: 'Fidèle et promis.' },
        { name: 'Manu', meaning: 'Dieu avec nous', personality: 'Protégé et béni.' },
        { name: 'Marcel', meaning: 'Petit guerrier', personality: 'Combatif et déterminé.' },
        { name: 'Marius', meaning: 'Mâle', personality: 'Viril et fort.' },
        { name: 'Mathias', meaning: 'Don de Dieu', personality: 'Béni et généreux.' },
        { name: 'Matthias', meaning: 'Don de Dieu', personality: 'Précieux et donné.' },
        { name: 'Maurice', meaning: 'Maure', personality: 'Mystérieux et profond.' },
        { name: 'Max', meaning: 'Le plus grand', personality: 'Ambitieux et excellent.' },
        { name: 'Maximilien', meaning: 'Le plus grand', personality: 'Grandiose et noble.' },
        { name: 'Morgan', meaning: 'De la mer', personality: 'Profond et mystérieux.' },
      ],
      N: [
        { name: 'Nathan', meaning: 'Donné par Dieu', personality: 'Béni et précieux.' },
        { name: 'Nicolas', meaning: 'Victoire du peuple', personality: 'Populaire et victorieux.' },
        ...
        { name: 'Napoléon', meaning: 'Lion de Naples', personality: 'Conquérant et ambitieux.' },
        { name: 'Narcisse', meaning: 'Engourdissement', personality: 'Beau et contemplatif.' },
        { name: 'Nestor', meaning: 'Retour', personality: 'Sage et expérimenté.' },
        { name: 'Nicéphore', meaning: 'Porteur de victoire', personality: 'Victorieux et triomphant.' },
        { name: 'Nicodème', meaning: 'Victoire du peuple', personality: 'Populaire et sage.' },
        { name: 'Nils', meaning: 'Champion du peuple', personality: 'Populaire et fort.' },
        { name: 'Noël', meaning: 'Naissance', personality: 'Joyeux et festif.' },
        { name: 'Norbert', meaning: 'Nord brillant', personality: 'Lumineux et guidant.' },
      ],
      O: [
        { name: 'Olivier', meaning: 'Olivier', personality: 'Pacifique et sage.' },
        { name: 'Oscar', meaning: 'Lance divine', personality: 'Divin et puissant.' },
        { name: 'Octave', meaning: 'Huitième', personality: 'Musical et harmonieux.' },
        { name: 'Odilon', meaning: 'Richesse', personality: 'Prospère et généreux.' },
        { name: 'Odon', meaning: 'Richesse', personality: 'Fortuné et sage.' },
        { name: 'Omar', meaning: 'Vie longue', personality: 'Durable et sage.' },
        { name: 'Onésime', meaning: 'Utile', personality: 'Serviable et pratique.' },
        { name: 'Oswald', meaning: 'Puissance divine', personality: 'Puissant et spirituel.' },
      ],
      P: [
        { name: 'Paul', meaning: 'Petit', personality: 'Humble et modeste.' },
        { name: 'Pierre', meaning: 'Roc', personality: 'Solide et fiable.' },
        { name: 'Philippe', meaning: 'Ami des chevaux', personality: 'Libre et noble.' },
        { name: 'Patrick', meaning: 'Noble', personality: 'Distingué et digne.' },
        { name: 'Pascal', meaning: 'De Pâques', personality: 'Renouvelé et joyeux.' },
        { name: 'Paulin', meaning: 'Petit', personality: 'Modeste et humble.' },
        { name: 'Pierrick', meaning: 'Petite pierre', personality: 'Solide et fidèle.' },
        { name: 'Pol', meaning: 'Petit', personality: 'Simple et authentique.' },
        { name: 'Prosper', meaning: 'Prospère', personality: 'Fortuné et chanceux.' },
      ],
      Q: [
        { name: 'Quentin', meaning: 'Cinquième', personality: 'Équilibré et harmonieux.' },
        { name: 'Quintin', meaning: 'Cinquième', personality: 'Sage et mesuré.' },
      ],
      R: [
        ...
        { name: 'Raymond', meaning: 'Conseil protecteur', personality: 'Sage et protecteur.' },
        { name: 'Régis', meaning: 'Roi', personality: 'Royal et majestueux.' },
        { name: 'Renaud', meaning: 'Conseil puissant', personality: 'Sage et fort.' },
        { name: 'René', meaning: 'Renaître', personality: 'Renouvelé et transformé.' },
        { name: 'Richard', meaning: 'Puissant et courageux', personality: 'Fort et brave.' },
        { name: 'Robert', meaning: 'Gloire brillante', personality: 'Glorieux et lumineux.' },
        { name: 'Rodolphe', meaning: 'Loup glorieux', personality: 'Sauvage et noble.' },
        { name: 'Roger', meaning: 'Lance glorieuse', personality: 'Glorieux et combatif.' },
        { name: 'Roland', meaning: 'Gloire du pays', personality: 'Patriote et héroïque.' },
        { name: 'Romuald', meaning: 'Gloire de Rome', personality: 'Glorieux et puissant.' },
        { name: 'Ronan', meaning: 'Petit phoque', personality: 'Agile et joueur.' },
      ],
      S: [
        ...
        { name: 'Sébastien', meaning: 'Vénérable', personality: 'Respectable et digne.' },
        { name: 'Stéphane', meaning: 'Couronné', personality: 'Victorieux et accompli.' },
        { name: 'Sacha', meaning: 'Défenseur', personality: 'Protecteur et loyal.' },
        { name: 'Salomon', meaning: 'Paix', personality: 'Sage et pacifique.' },
        { name: 'Serge', meaning: 'Gardien', personality: 'Protecteur et vigilant.' },
        { name: 'Severin', meaning: 'Sévère', personality: 'Strict mais juste.' },
        { name: 'Stanislas', meaning: 'Gloire de l\'État', personality: 'Patriote et noble.' },
        { name: 'Sylvain', meaning: 'De la forêt', personality: 'Naturel et sauvage.' },
        { name: 'Sylvestre', meaning: 'De la forêt', personality: 'Proche de la nature.' },
      ],
      T: [
        ...
        { name: 'Tanguy', meaning: 'Guerrier', personality: 'Combatif et brave.' },
        { name: 'Teddy', meaning: 'Don de Dieu', personality: 'Béni et câlin.' },
        { name: 'Théodore', meaning: 'Don de Dieu', personality: 'Béni et sage.' },
        { name: 'Théophile', meaning: 'Ami de Dieu', personality: 'Spirituel et aimant.' },
        { name: 'Thierry', meaning: 'Roi du peuple', personality: 'Royal et populaire.' },
        { name: 'Timéo', meaning: 'Qui honore Dieu', personality: 'Dévoué et fidèle.' },
        { name: 'Tristan', meaning: 'Tumulte', personality: 'Passionné et intense.' },
      ],
      U: [
        { name: 'Ulysse', meaning: 'Celui qui déteste', personality: 'Voyageur et courageux.' },
      ...
      V: [
        ...
        { name: 'Valéry', meaning: 'Vaillant', personality: 'Courageux et fort.' },
        { name: 'Vianney', meaning: 'Vivant', personality: 'Plein de vie.' },
        { name: 'Victorien', meaning: 'Victorieux', personality: 'Triomphant et fier.' },
        { name: 'Virgile', meaning: 'Baguette', personality: 'Guide et poète.' },
        { name: 'Vivien', meaning: 'Vivant', personality: 'Dynamique et énergique.' },
      ],
      W: [
        { name: 'William', meaning: 'Volonté et protection', personality: 'Protecteur et déterminé.' },
        { name: 'Wilfried', meaning: 'Paix voulue', personality: 'Pacifique et résolu.' },
      ],
      X: [
        { name: 'Xavier', meaning: 'Maison neuve', personality: 'Bâtisseur et créateur.' },
        { name: 'Xénophon', meaning: 'Voix étrangère', personality: 'Unique et original.' },
      ],
      Y: [
        { name: 'Yann', meaning: 'Dieu fait grâce', personality: 'Béni et reconnaissant.' },
        { name: 'Yves', meaning: 'If', personality: 'Solide et durable.' },
        { name: 'Yanis', meaning: 'Dieu est gracieux', personality: 'Gracieux et aimable.' },
        { name: 'Yoann', meaning: 'Dieu fait grâce', personality: 'Béni et talentueux.' },
        { name: 'Yohan', meaning: 'Dieu fait grâce', personality: 'Gracieux et fidèle.' },
        { name: 'Yvon', meaning: 'If', personality: 'Résistant et fidèle.' },
      ],
      Z: [
        { name: 'Zacharie', meaning: 'Dieu se souvient', personality: 'Mémorable et inoubliable.' },
        { name: 'Zéphyr', meaning: 'Vent d\'ouest', personality: 'Libre et léger.' },
      ],
    },
  },
