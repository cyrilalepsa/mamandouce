...
export const babyNamesData = {
  // FRANCE - Prénoms modernes et tendance 2020-2025
  FR: {
    girls: {
      A: [
        ...
        { name: 'Andrea', meaning: 'Courageuse', personality: 'Forte et moderne.' },
      ...
      E: [
        ...
        { name: 'Ève', meaning: 'Vie', personality: 'Première et originelle.' },
      ],
      F: [
      ...
      L: [
        ...
        { name: 'Lia', meaning: 'Porteuse bonnes nouvelles', personality: 'Joyeuse et positive.' },
    ...
    boys: {
      ...
      B: [
        ...
        { name: 'Bilal', meaning: 'Humidité', personality: 'Rafraîchissant et moderne.' },
      ],
      C: [
