  ...
  if (compact) {
    return (
      <div className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-pink-500/10 to-purple-500/10 rounded-2xl">
        ...
        <div>
          <p className={`text-xs ${textMuted}`} style={textShadow}>Ma cagnotte</p>
          <p className={`text-lg font-bold ${textColor}`} style={textShadow}>{wallet?.balance || 0}€</p>
        </div>
      </div>
    );
  }
    ...
    <Card className={`${cardBg} rounded-3xl overflow-hidden`}>
      ...
      <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 p-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-white/80 text-sm" style={textShadow}>Ma Cagnotte Solidaire</p>
              <p className="text-3xl font-bold text-white" style={textShadow}>{wallet?.balance || 0}€</p>
            </div>
          </div>
      ...
      <div className="p-5">
        ...
        <div className={`mt-4 p-3 ${isDarkMode ? 'bg-purple-900/30' : 'bg-purple-50'} rounded-xl`}>
          <p className={`text-xs ${textMuted}`} style={textShadow}>
            💡 Gagnez <span className="font-medium text-purple-500">+3€</span> pour chaque parrainage réussi 
            et <span className="font-medium text-purple-500">+1€</span> par contribution validée !
          </p>
        </div>
      </div>
    </Card>
