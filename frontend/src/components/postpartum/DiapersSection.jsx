          ...
          <PastelCard color="sky" className="p-4">
            ...
            {diapers.change_tutorial.video_url && (
              <a href={diapers.change_tutorial.video_url} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-red-100/60 text-red-700 px-3 py-2 rounded-full text-sm font-semibold hover:bg-red-200/60 mt-3 backdrop-blur-sm">
